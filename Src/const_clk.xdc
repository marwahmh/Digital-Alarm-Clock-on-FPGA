...
#set_property PACKAGE_PIN W14 [get_ports sel_clock ]
#set_property IOSTANDARD LVCMOS33 [get_ports sel_clock ]
# set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets sel_clock_IBUF] 
#set_property PACKAGE_PIN R3 [get_ports BTNL]
#set_property IOSTANDARD LVCMOS33 [get_ports BTNL]
#set_property PACKAGE_PIN T2 [get_ports BTNR]
#set_property IOSTANDARD LVCMOS33 [get_ports BTNR]


#set_property PACKAGE_PIN T1 [get_ports ld]
...
#set_property PACKAGE_PIN U16 [get_ports RingNow]
#set_property IOSTANDARD LVCMOS33 [get_ports RingNow]
set_property PACKAGE_PIN U16 [get_ports led_alarm]
...
set_property PACKAGE_PIN V7 [get_ports dotO]
set_property IOSTANDARD LVCMOS33 [get_ports dotO]